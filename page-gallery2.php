...
?>
<style>
#cboxContent #cboxPrevious,#cboxContent #cboxNext, #cboxSlideshow, #cboxClose {
	border:0;padding:0;margin:0;overflow:visible;text-indent:-9999px; right: 0%;
				...
				<ul class="row gallery-row">
					<div class="col-lg-12"> 
						...
						?>
								...
								style="height: 291px;background-image: url('<?php echo $irow['thumb']?>');background-size: cover;background-position: center center;background-repeat: no-repeat; 
								display: block; width: 100%; background-position-y: 0px;"  >
									<img class="img-responsive" src="<?php echo $irow['thumb']?> " style="display: none;" >
								</a>
							</li>
						<?php }} ?>
					</ul>
				...
				<ul class="row gallery-row">
					<div class="col-lg-12"> 
						...
						?>
							...
							<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
								<a href="<?php echo $irow['source']?>" class="gallery" rel="gal" title="<?php echo $irow['title']?>"  
								style="height: 291px;background-image: url('<?php echo $irow['thumb']?>');background-size: cover;background-position: center center;background-repeat: no-repeat; display: block; width: 100%; background-position-y: 0px;">
									<img class="img-responsive" src="<?php echo $irow['thumb']?>" style="display: none;">
								</a>
							</li>
